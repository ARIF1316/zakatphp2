<?php
// Koneksi Database
$koneksi = mysqli_connect("localhost", "root", "", "zakaat3");
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', prodi = '$prodi', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nis = $nis";
