...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem pembayaran zakat mahasiswa</a>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="prodi" name="prodi">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        prodi--------------------------------------------</option>
                                   <option value="Teknik nformatika" <?php if ($siswa['jurusan'] == 'Teknik informatika') { ?>
                                        selected='' <?php } ?>>Teknik informatika</option>
                                   <option value="Teknik elektro"
                                        <?php if ($siswa['jurusan'] == 'Teknik elektro') { ?> selected=''
                                        <?php } ?>>Teknik elektro</option>
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                    BY:
                         M.arif (2222105115) Ilham mahdani(2222105091) Kuntum(2222105108) Ilham surya ptatama(2222105092)
                    </p>
               </div>
          </div>
     </div>
